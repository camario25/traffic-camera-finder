...
def get_verified_camera_data():
    ...
    oakland_cameras = [
        ...
        {"id": "oak-002", "latitude": 37.8550, "longitude": -122.2490, "city": "Oakland", "camera_type": "speed", "address": "Claremont Ave (Hillegass-College Ave)"},
        {"id": "oak-003", "latitude": 37.7850, "longitude": -122.2240, "city": "Oakland", "camera_type": "speed", "address": "Foothill Blvd (Irving St-24th Ave)"},
        {"id": "oak-004", "latitude": 37.7920, "longitude": -122.2280, "city": "Oakland", "camera_type": "speed", "address": "Foothill Blvd (19th-20th Ave)"},
        {"id": "oak-005", "latitude": 37.8050, "longitude": -122.2950, "city": "Oakland", "camera_type": "speed", "address": "7th St (Adeline-Linden St)"},
        ...
        {"id": "oak-009", "latitude": 37.8020, "longitude": -122.2720, "city": "Oakland", "camera_type": "speed", "address": "7th St (Broadway-Franklin St)"},
        {"id": "oak-010", "latitude": 37.8180, "longitude": -122.1950, "city": "Oakland", "camera_type": "speed", "address": "MacArthur Blvd (Green Acre Rd-Enos Ave)"},
        {"id": "oak-011", "latitude": 37.7780, "longitude": -122.2240, "city": "Oakland", "camera_type": "speed", "address": "Fruitvale Ave (Galindo-Logan St)"},
        {"id": "oak-012", "latitude": 37.7750, "longitude": -122.2180, "city": "Oakland", "camera_type": "speed", "address": "International Blvd (40th-41st Ave)"},
        {"id": "oak-013", "latitude": 37.7380, "longitude": -122.1950, "city": "Oakland", "camera_type": "speed", "address": "Hegenberger Rd (Spencer-Hawley St)"},
        {"id": "oak-014", "latitude": 37.7580, "longitude": -122.1820, "city": "Oakland", "camera_type": "speed", "address": "73rd Ave (Fresno St-Krause Ave)"},
        {"id": "oak-015", "latitude": 37.7450, "longitude": -122.1680, "city": "Oakland", "camera_type": "speed", "address": "Bancroft Ave (86th-Auseon Ave)"},
        {"id": "oak-016", "latitude": 37.7380, "longitude": -122.1580, "city": "Oakland", "camera_type": "speed", "address": "98th Ave (Blake Dr-Gould St)"},
        {"id": "oak-017", "latitude": 37.7420, "longitude": -122.1620, "city": "Oakland", "camera_type": "speed", "address": "98th Ave (Cherry-Birch St)"},
        {"id": "oak-018", "latitude": 37.7650, "longitude": -122.1880, "city": "Oakland", "camera_type": "speed", "address": "Bancroft Ave (61st-62nd Ave)"},
    ]
